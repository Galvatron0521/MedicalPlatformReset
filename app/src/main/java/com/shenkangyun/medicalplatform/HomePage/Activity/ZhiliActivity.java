...
public class ZhiliActivity extends AppCompatActivity {
    ...
    private String[] Names = new String[]{"泰山区人民医院儿康中心", "泰山区小天使康复中心", "泰山区智康能力儿童活动中心", "泰山区东岳特教中心", "星童特教学校"};
    private String[] OrganizeID = new String[]{"1", "2", "3", "4", "40288056695c751401695c7bd3010001"};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_zhili);
    ...
    private void initData() {
        ...
        volunteerAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                Intent intent = new Intent(ZhiliActivity.this, KangfuServiceActivity.class);
