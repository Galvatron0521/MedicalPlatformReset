...
public class NaotanActivity extends AppCompatActivity {
    ...
    private String[] Names = new String[]{"泰山区人民医院儿康中心", "泰山区小天使康复中心"};
    private String[] OrganizeID = new String[]{"1", "2"};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_naotan);
    ...
    private void initData() {
        ...
        volunteerAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                Intent intent = new Intent(NaotanActivity.this, KangfuServiceActivity.class);
                intent.putExtra("unitID", unitID.get(position));
                intent.putExtra("unitName", unitName.get(position));
                intent.putExtra("recoveryType", "2");
