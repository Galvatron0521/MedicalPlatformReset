...
public class ShiliActivity extends AppCompatActivity {
    ...
    private String[] Names = new String[]{"泰安市姜玉坤眼镜有限公司", "泰安市爱尔眼科医院"};
    private String[] OrganizeID = new String[]{"7","6"};
    ...
    private void initData() {
        ...
        volunteerAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                Intent intent = new Intent(ShiliActivity.this, KangfuServiceActivity.class);
                intent.putExtra("unitID", unitID.get(position));
                intent.putExtra("unitName", unitName.get(position));
                intent.putExtra("recoveryType", "5");
