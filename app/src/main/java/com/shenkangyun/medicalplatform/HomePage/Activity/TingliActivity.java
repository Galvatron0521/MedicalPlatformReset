...
public class TingliActivity extends AppCompatActivity {
    ...
    private String[] Names = new String[]{"泰安市康复中心"};
    private String[] OrganizeID = new String[]{"402880526265f05b016265f950af0068"};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tingli);
    ...
    private void initData() {
        ...
        volunteerAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                Intent intent = new Intent(TingliActivity.this, KangfuServiceActivity.class);
                intent.putExtra("unitID", unitID.get(position));
                intent.putExtra("unitName", unitName.get(position));
                intent.putExtra("recoveryType", "4");
