...
public class LimsRecoveryActivity extends AppCompatActivity {
    ...
    private String[] Names = new String[]{"市妇幼保健院", "泰山疗养院", "泰安市优抚医院", "泰安市中医二院"};
    private String[] OrganizeID = new String[]{"4028e47b6993a599016993cbdd0d0013", "4028e47b6993a599016993d62d3b0016", "4028e47b6993a599016993d7f6200019", "15"};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_lims_recovery);
    ...
    private void initData() {
        ...
        volunteerAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                Intent intent = new Intent(LimsRecoveryActivity.this, KangfuServiceActivity.class);
                intent.putExtra("unitID", unitID.get(position));
                intent.putExtra("unitName", unitName.get(position));
                intent.putExtra("recoveryType", "1");
