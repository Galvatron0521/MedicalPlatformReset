...
import com.shenkangyun.medicalplatform.BeanFolder.LimbsBean;
...
public class LimbsAdapter extends BaseQuickAdapter<HospitalBean.DataBean.ListBean, BaseViewHolder> {
    public LimbsAdapter() {
