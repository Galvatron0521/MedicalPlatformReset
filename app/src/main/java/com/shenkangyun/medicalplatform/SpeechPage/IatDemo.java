...
public class IatDemo extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mToast = Toast.makeText(IatDemo.this, "", Toast.LENGTH_SHORT);
    ...
    private InitListener mInitListener = new InitListener() {
        ...
        public void onInit(int code) {
            Log.d("123456", "SpeechRecognizer init() code = " + code);
    ...
    private RecognizerListener mRecognizerListener = new RecognizerListener() {
        ...
        public void onResult(RecognizerResult results, boolean isLast) {
            Log.d("123456", results.getResultString());
            if( mTranslateEnable ){
        ...
        public void onVolumeChanged(int volume, byte[] data) {
            ...
            Log.d("123456", "返回音频数据："+data.length);
        }
    ...
    public void onResume() {
        ...
        FlowerCollector.onPageStart("123456");
        super.onResume();
    }
    ...
    public void onPause() {
        // 开放统计 移动数据统计分析
        FlowerCollector.onPageEnd("123456");
