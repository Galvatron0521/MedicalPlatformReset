...
import com.shenkangyun.medicalplatform.BeanFolder.UpdateBean;
...
import com.shenkangyun.medicalplatform.UtilsFolder.APKVersionCodeUtils;
...
public class MinePageActivity extends AppCompatActivity {
    ...
    @OnClick({R.id.img_portrait, R.id.tv_changeWord, R.id.tv_quit, R.id.tv_update, R.id.tv_about, R.id.tv_jinDu})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.tv_about:
                ...
                break;
            case R.id.tv_jinDu:
                Intent jinDu = new Intent(this, JinduActivity.class);
                jinDu.putExtra("id", id);
                startActivity(jinDu);
                break;
        }
    }
    ...
    private void installApk(File file) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            data = FileProvider.getUriForFile(this, "com.shenkangyun.medicalplatform.fileprovider", file);
            // 给目标应用一个临时授权
