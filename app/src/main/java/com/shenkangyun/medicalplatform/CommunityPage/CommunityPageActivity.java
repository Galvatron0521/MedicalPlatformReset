...
import com.shenkangyun.medicalplatform.BeanFolder.ZanRespond;
...
public class CommunityPageActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        communityRecycler.addItemDecoration(new DividerItemDecoration(this, DividerItemDecoration.VERTICAL));
    ...
    private void initNetRequest() {
        ...
        OkHttpUtils.post()
                ...
                .addParams("data", new CommunityPageFragment.communityShowList(Base.getMD5Str(), Base.getTimeSpan(), Base.getUserName(), "1", String.valueOf(pageNo),
                        String.valueOf(pageCount)).toJson())
                .build().execute(new GsonCallBack<CommunityBean>() {
            @Override
            public void onSuccess(CommunityBean response) {
                    ...
                    public void run() {
                        ...
                        if (!(size < pageCount)) {
                            ...
                            OkHttpUtils.post()
                                    .url(Base.URL)
                                    .addParams("act", "communityShowList")
                                    .addParams("data", new CommunityPageFragment.communityShowList(Base.getMD5Str(), Base.getTimeSpan(), Base.getUserName(), "1", String.valueOf(pageNo), String.valueOf(pageCount)).toJson())
                                    .build().execute(new GsonCallBack<CommunityBean>() {
                                @Override
            ...
            public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
                switch (view.getId()) {
                    case R.id.comm_content:
                        ...
                        Intent intent = new Intent(CommunityPageActivity.this, CommunityInfoActivity.class);
                    ...
                    case R.id.supportTxt:
                        ...
                        if (totalList.get(position).getZanList().size() > 0) {
                            Toast.makeText(CommunityPageActivity.this, "已点赞", Toast.LENGTH_SHORT).show();
                        } else {
                            supportTxt.setImageResource(R.drawable.zan_true);
                            initZan(position);
                            Toast.makeText(CommunityPageActivity.this, "你点击了按钮", Toast.LENGTH_SHORT).show();
                        }
                        break;
                }
            }
    ...
    private void initZan(final int position) {
        ...
        OkHttpUtils.post()
                ...
                .addParams("data", new CommunityPageFragment.onclickZan(Base.getMD5Str(), Base.getTimeSpan(), "1", "", showId, userName, "0").toJson())
            ...
            public void onSuccess(ZanRespond response) throws JSONException {
                ...
                if ("0".equals(status)) {
                    ...
                    Toast.makeText(CommunityPageActivity.this, "点赞失败", Toast.LENGTH_SHORT).show();
                }
            }
